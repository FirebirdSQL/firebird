...
DeclareSubFuncNode* DsqlCompilerScratch::getSubFunction(const Jrd::MetaName& name)
{
...
DeclareSubProcNode* DsqlCompilerScratch::getSubProcedure(const Jrd::MetaName& name)
{
