...
%union YYSTYPE
{
	...
	PodOptional<int> nullableIntVal;
	TriState triState;
	PodOptional<SqlSecurity> nullableSqlSecurityVal;
	PodOptional<OverrideClause> nullableOverrideClause;
	...
	SINT64 int64Val;
	FB_UINT64 uint64Val;
	PodOptional<SINT64> nullableInt64Val;
	PodOptional<FB_UINT64> nullableUint64Val;
	ScaledNumber scaledNumber;
	UCHAR blrOp;
	OrderNode::NullsPlacement nullsPlacement;
	ComparativeBoolNode::DsqlFlag cmpBoolFlag;
	dsql_fld* legacyField;
	ReturningClause* returningClause;
	MetaName* metaNamePtr;
	ObjectsArray<MetaName>* metaNameArray;
	ObjectsArray<QualifiedName>* qualifiedNameArray;
	PathName* pathNamePtr;
	QualifiedName* qualifiedNamePtr;
	string* stringPtr;
	IntlString* intlStringPtr;
	Lim64String* lim64ptr;
	ExternalClause* externalClause;
	NonPooledPair<MetaName*, ValueExprNode*>* namedArgument;
	NonPooledPair<ObjectsArray<MetaName>*, ValueListNode*>* namedArguments;
	Array<NestConst<ParameterClause> >* parametersClause;
	WindowClause* windowClause;
	WindowClause::FrameExtent* windowClauseFrameExtent;
	WindowClause::Frame* windowClauseFrame;
	WindowClause::Exclusion windowClauseExclusion;
	Node* node;
	ExprNode* exprNode;
	ValueExprNode* valueExprNode;
	BoolExprNode* boolExprNode;
	RecordSourceNode* recSourceNode;
	RelationSourceNode* relSourceNode;
	ValueListNode* valueListNode;
	RecSourceListNode* recSourceListNode;
	RseNode* rseNode;
	PlanNode* planNode;
	PlanNode::AccessType* accessType;
	StmtNode* stmtNode;
	DdlNode* ddlNode;
	SelectExprNode* selectExprNode;
	WithClause* withClause;
	RowsClause* rowsClause;
	FieldNode* fieldNode;
	DecodeNode* decodeNode;
	Array<FieldNode*>* fieldArray;
	Array<NestConst<FieldNode> >* nestFieldArray;
	NamedWindowClause* namedWindowClause;
	NamedWindowsClause* namedWindowsClause;
	TransactionNode* traNode;
	SessionManagementNode* mngNode;
	Array<PrivilegeClause>* privilegeArray;
	GranteeClause* granteeClause;
	Array<GranteeClause>* granteeArray;
	GrantRevokeNode* grantRevokeNode;
	CreateCollationNode* createCollationNode;
	CreateDomainNode* createDomainNode;
	AlterDomainNode* alterDomainNode;
	CreateAlterFunctionNode* createAlterFunctionNode;
	CreateAlterProcedureNode* createAlterProcedureNode;
	CreateAlterTriggerNode* createAlterTriggerNode;
	CreateAlterPackageNode* createAlterPackageNode;
	CreateFilterNode::NameNumber* filterNameNumber;
	CreateAlterExceptionNode* createAlterExceptionNode;
	CreateAlterSequenceNode* createAlterSequenceNode;
	CreateAlterSchemaNode* createAlterSchemaNode;
	CreateFilterNode* createFilterNode;
	CreateShadowNode* createShadowNode;
	Array<CreateAlterPackageNode::Item>* packageItems;
	ExceptionArray* exceptionArray;
	CreateAlterPackageNode::Item packageItem;
	CreatePackageBodyNode* createPackageBodyNode;
	BoolSourceClause* boolSourceClause;
	ValueSourceClause* valueSourceClause;
	RelationNode* relationNode;
	RelationNode::AddColumnClause* addColumnClause;
	RelationNode::AddConstraintClause* addConstraintClause;
	RelationNode::RefActionClause* refActionClause;
	RelationNode::IndexConstraintClause* indexConstraintClause;
	RelationNode::IdentityOptions* identityOptions;
	IdentityType identityType;
	CreateRelationNode* createRelationNode;
	CreateAlterViewNode* createAlterViewNode;
	CreateIndexNode* createIndexNode;
	AlterDatabaseNode* alterDatabaseNode;
	ExecBlockNode* execBlockNode;
	StoreNode* storeNode;
	UpdateOrInsertNode* updInsNode;
	UsingNode* usingNode;
	AggNode* aggNode;
	SysFuncCallNode* sysFuncCallNode;
	ValueIfNode* valueIfNode;
	CompoundStmtNode* compoundStmtNode;
	CursorStmtNode* cursorStmtNode;
	DeclareCursorNode* declCursorNode;
	ErrorHandlerNode* errorHandlerNode;
	ExecStatementNode* execStatementNode;
	LocalDeclarationsNode* localDeclarationsNode;
	MergeNode* mergeNode;
	MergeNode::NotMatched* mergeNotMatchedClause;
	MergeNode::Matched* mergeMatchedClause;
	SelectNode* selectNode;
	ForNode* forNode;
	SetTransactionNode* setTransactionNode;
	SetTransactionNode::RestrictionOption* setTransactionRestrictionClause;
	DeclareSubProcNode* declareSubProcNode;
	DeclareSubFuncNode* declareSubFuncNode;
	DsqlStatement* dsqlStatement;
	CreateAlterUserNode* createAlterUserNode;
	MappingNode* mappingNode;
	MappingNode::OP mappingOp;
	SetRoleNode* setRoleNode;
	SetSessionNode* setSessionNode;
	CreateAlterRoleNode* createAlterRoleNode;
	SetDecFloatRoundNode* setDecFloatRoundNode;
	SetDecFloatTrapsNode* setDecFloatTrapsNode;
	SetBindNode* setBindNode;
	SessionResetNode* sessionResetNode;
