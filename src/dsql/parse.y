...
object
	...
	| TABLESPACE
		{ $$ = newNode<GranteeClause>(obj_tablespaces, getSecurityClassName(obj_tablespaces)); }
	;
...
alter_index_clause
	: symbol_index_name index_active	{ $$ = newNode<AlterIndexNode>(*$1, $2); }
...
index_active
	: ACTIVE	{ $$ = AlterIndexNode::OP_ACTIVE; }
	| INACTIVE	{ $$ = AlterIndexNode::OP_INACTIVE; }
	;
