...
public:
	CreateAlterPackageNode(MemoryPool& pool, const Jrd::MetaName& aName)
		: DdlNode(pool),
		  name(pool, aName),
		  create(true),
		  alter(false),
...
public:
	...
	Firebird::SortedArray<Jrd::MetaName> functionNames;
	Firebird::SortedArray<Jrd::MetaName> procedureNames;
...
{
public:
	DropPackageNode(MemoryPool& pool, const Jrd::MetaName& aName)
		: DdlNode(pool),
		  name(pool, aName),
		  silent(false)
	{
...
{
public:
	CreatePackageBodyNode(MemoryPool& pool, const Jrd::MetaName& aName)
		: DdlNode(pool),
		  name(pool, aName),
		  source(pool),
		  declaredItems(NULL),
...
{
public:
	DropPackageBodyNode(MemoryPool& pool, const Jrd::MetaName& aName)
		: DdlNode(pool),
		  name(pool, aName),
		  silent(false)
	{
