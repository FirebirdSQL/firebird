...
FB_IMPL_MSG(JRD, 1023, foreign_server, -901, "42", "000", "foreign server @1")
FB_IMPL_MSG(JRD, 1024, foreign_provider_not_found, -901, "42", "000", "Foreign provider '@1' for server '@2' not found")
FB_IMPL_MSG(JRD, 1025, foreign_option_length_err, -901, "22", "000", "foreign option length @1 exceeds limit @2")
