...
FB_IMPL_MSG(JRD, 969, invalid_date_format, -901, "HY", "000", "Cannot recognize \"@1\" part of date format")
FB_IMPL_MSG(JRD, 970, invalid_raw_string_in_date_format, -901, "HY", "000", "Cannot find closing \" for raw text in date format")
FB_IMPL_MSG(JRD, 971, invalid_data_type_for_date_format, -901, "HY", "000", "It is not possible to use this data type for date formatting")
FB_IMPL_MSG(JRD, 972, incompatible_date_format_with_current_date_type, -901, "HY", "000", "Cannot use \"@1\" format with current date type")
