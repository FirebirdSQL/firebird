...
FB_IMPL_MSG(JRD, 1021, hypfun_args_non_equal_sort_item, -833, "42", "000", "Number of arguments hypothetical-set aggregate function @1 must match number of sort items in WITHIN GROUP")
