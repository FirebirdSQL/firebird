...
FB_IMPL_MSG_NO_SYMBOL(GBAK, 428, "writing tablespaces")
FB_IMPL_MSG_NO_SYMBOL(GBAK, 429, "writing tablespace @1")
FB_IMPL_MSG_NO_SYMBOL(GBAK, 430, "restoring tablespace @1")
FB_IMPL_MSG_NO_SYMBOL(GBAK, 431, "tablespace")
FB_IMPL_MSG_NO_SYMBOL(GBAK, 432, "    @1TS_MAP(PING_FILE) <mapping file>         mapping file for tablespaces")
FB_IMPL_MSG_NO_SYMBOL(GBAK, 433, "path to tablespace @1 is not specified (original path: \"@2\")")
FB_IMPL_MSG_NO_SYMBOL(GBAK, 434, "    @1TS_ORIG(INAL_PATHS)        restore tablespaces to their original paths")
FB_IMPL_MSG_NO_SYMBOL(GBAK, 435, "    @1TS <tablespace> <path>     set a path for a tablespace")
FB_IMPL_MSG_NO_SYMBOL(GBAK, 436, "parameter for option -@1 is missing")
FB_IMPL_MSG_NO_SYMBOL(GBAK, 437, "cannot open mapping file \"@1\"")
