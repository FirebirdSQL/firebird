...
FB_IMPL_MSG_NO_SYMBOL(GBAK, 428, "writing foreign servers")
FB_IMPL_MSG_NO_SYMBOL(GBAK, 429, "    writing foreign server @1")
FB_IMPL_MSG_NO_SYMBOL(GBAK, 430, "restoring foreign server @1")
FB_IMPL_MSG_NO_SYMBOL(GBAK, 431, "foreign server")
FB_IMPL_MSG_NO_SYMBOL(GBAK, 432, "         writing foreign server option @1")
FB_IMPL_MSG_NO_SYMBOL(GBAK, 433, "    restoring foreign server option @1")
FB_IMPL_MSG_NO_SYMBOL(GBAK, 434, "foreign server option")
FB_IMPL_MSG_NO_SYMBOL(GBAK, 435, "         writing foreign table option @1")
FB_IMPL_MSG_NO_SYMBOL(GBAK, 436, "    restoring foreign table option @1")
FB_IMPL_MSG_NO_SYMBOL(GBAK, 437, "foreign table option")
FB_IMPL_MSG_NO_SYMBOL(GBAK, 438, "              writing foreign table column option @1")
FB_IMPL_MSG_NO_SYMBOL(GBAK, 439, "         restoring foreign table column option @1")
FB_IMPL_MSG_NO_SYMBOL(GBAK, 440, "foreign table column option")
FB_IMPL_MSG_NO_SYMBOL(GBAK, 441, "writing foreign user mappings")
FB_IMPL_MSG_NO_SYMBOL(GBAK, 442, "    writing foreign user mapping for user @1 and server @2")
FB_IMPL_MSG_NO_SYMBOL(GBAK, 443, "restoring foreign user mapping for user @1 and server @2")
FB_IMPL_MSG_NO_SYMBOL(GBAK, 444, "foreign user mapping")
FB_IMPL_MSG_NO_SYMBOL(GBAK, 445, "         writing foreign user mapping option @1")
FB_IMPL_MSG_NO_SYMBOL(GBAK, 446, "    restoring foreign user mapping option @1")
FB_IMPL_MSG_NO_SYMBOL(GBAK, 447, "foreign user mapping option")
