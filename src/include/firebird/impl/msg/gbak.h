...
FB_IMPL_MSG_NO_SYMBOL(GBAK, 415, "    @1TS_MAP(PING_FILE) <mapping file>         mapping file for tablespaces")
...
FB_IMPL_MSG_NO_SYMBOL(GBAK, 418, "    @1TS <tablespace> <path>     set a path for a tablespace")
