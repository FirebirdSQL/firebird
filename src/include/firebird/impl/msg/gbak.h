...
FB_IMPL_MSG_NO_SYMBOL(GBAK, 427, "writing foreign servers")
FB_IMPL_MSG_NO_SYMBOL(GBAK, 428, "    writing foreign server @1")
FB_IMPL_MSG_NO_SYMBOL(GBAK, 429, "restoring foreign server @1")
FB_IMPL_MSG_NO_SYMBOL(GBAK, 430, "foreign server")
FB_IMPL_MSG_NO_SYMBOL(GBAK, 431, "         writing foreign server option @1")
FB_IMPL_MSG_NO_SYMBOL(GBAK, 432, "    restoring foreign server option @1")
FB_IMPL_MSG_NO_SYMBOL(GBAK, 433, "foreign server option")
FB_IMPL_MSG_NO_SYMBOL(GBAK, 434, "         writing foreign table option @1")
FB_IMPL_MSG_NO_SYMBOL(GBAK, 435, "    restoring foreign table option @1")
FB_IMPL_MSG_NO_SYMBOL(GBAK, 436, "foreign table option")
FB_IMPL_MSG_NO_SYMBOL(GBAK, 437, "              writing foreign table column option @1")
FB_IMPL_MSG_NO_SYMBOL(GBAK, 438, "         restoring foreign table column option @1")
FB_IMPL_MSG_NO_SYMBOL(GBAK, 439, "foreign table column option")
FB_IMPL_MSG_NO_SYMBOL(GBAK, 440, "writing foreign user mappings")
FB_IMPL_MSG_NO_SYMBOL(GBAK, 441, "    writing foreign user mapping for user @1 and server @2")
FB_IMPL_MSG_NO_SYMBOL(GBAK, 442, "restoring foreign user mapping for user @1 and server @2")
FB_IMPL_MSG_NO_SYMBOL(GBAK, 443, "foreign user mapping")
FB_IMPL_MSG_NO_SYMBOL(GBAK, 444, "         writing foreign user mapping option @1")
FB_IMPL_MSG_NO_SYMBOL(GBAK, 445, "    restoring foreign user mapping option @1")
FB_IMPL_MSG_NO_SYMBOL(GBAK, 446, "foreign user mapping option")
