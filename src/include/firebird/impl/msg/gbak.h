...
FB_IMPL_MSG_NO_SYMBOL(GBAK, 423, "Compressor plugin '@1' not found")
FB_IMPL_MSG_NO_SYMBOL(GBAK, 424, "    @1COM(PRESSOR)         plugin name, compression level and threads count")
FB_IMPL_MSG_NO_SYMBOL(GBAK, 435, "Expected @1 instead of @2")
FB_IMPL_MSG_NO_SYMBOL(GBAK, 446, "compression level @1")
FB_IMPL_MSG_NO_SYMBOL(GBAK, 447, "'@1' compression plugin used")
FB_IMPL_MSG(GBAK, 448, gbak_writing_constants, -901, "00", "000", "writing constants")
FB_IMPL_MSG(GBAK, 449, gbak_writing_constant, -901, "00", "000", "writing constant %s for package %s")
FB_IMPL_MSG(GBAK, 450, gbak_constant, -901, "00", "000", "constant (in RDB$CONSTANTS)")
FB_IMPL_MSG(GBAK, 451, gbak_restoring_constant, -901, "00", "000", "restoring constant %s for package %s")
