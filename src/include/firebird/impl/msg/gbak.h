...
FB_IMPL_MSG_NO_SYMBOL(GBAK, 427, "    @1TS_MAP(PING_FILE) <mapping file>         mapping file for tablespaces")
...
FB_IMPL_MSG_NO_SYMBOL(GBAK, 430, "    @1TS <tablespace> <path>     set a path for a tablespace")
