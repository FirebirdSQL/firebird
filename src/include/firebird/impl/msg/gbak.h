...
FB_IMPL_MSG_NO_SYMBOL(GBAK, 423, "writing foreign servers")
FB_IMPL_MSG_NO_SYMBOL(GBAK, 424, "    writing foreign server @1")
FB_IMPL_MSG_NO_SYMBOL(GBAK, 425, "restoring foreign server @1")
FB_IMPL_MSG_NO_SYMBOL(GBAK, 426, "foreign server")
FB_IMPL_MSG_NO_SYMBOL(GBAK, 427, "         writing foreign server option @1")
FB_IMPL_MSG_NO_SYMBOL(GBAK, 428, "    restoring foreign server option @1")
FB_IMPL_MSG_NO_SYMBOL(GBAK, 429, "foreign server option")
FB_IMPL_MSG_NO_SYMBOL(GBAK, 430, "         writing foreign table option @1")
FB_IMPL_MSG_NO_SYMBOL(GBAK, 431, "    restoring foreign table option @1")
FB_IMPL_MSG_NO_SYMBOL(GBAK, 432, "foreign table option")
FB_IMPL_MSG_NO_SYMBOL(GBAK, 433, "              writing foreign table column option @1")
FB_IMPL_MSG_NO_SYMBOL(GBAK, 434, "         restoring foreign table column option @1")
FB_IMPL_MSG_NO_SYMBOL(GBAK, 435, "foreign table column option")
FB_IMPL_MSG_NO_SYMBOL(GBAK, 436, "writing foreign user mappings")
FB_IMPL_MSG_NO_SYMBOL(GBAK, 437, "    writing foreign user mapping for user @1 and server @2")
FB_IMPL_MSG_NO_SYMBOL(GBAK, 438, "restoring foreign user mapping for user @1 and server @2")
FB_IMPL_MSG_NO_SYMBOL(GBAK, 439, "foreign user mapping")
FB_IMPL_MSG_NO_SYMBOL(GBAK, 440, "         writing foreign user mapping option @1")
FB_IMPL_MSG_NO_SYMBOL(GBAK, 441, "    restoring foreign user mapping option @1")
FB_IMPL_MSG_NO_SYMBOL(GBAK, 442, "foreign user mapping option")
