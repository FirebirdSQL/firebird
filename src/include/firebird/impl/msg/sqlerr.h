...
FB_IMPL_MSG(SQLERR, 1053, dsql_create_foreign_server_failed, -901, "42", "000", "CREATE SERVER @1 failed")
FB_IMPL_MSG(SQLERR, 1054, dsql_alter_foreign_server_failed, -901, "42", "000", "ALTER SERVER @1 failed")
FB_IMPL_MSG(SQLERR, 1055, dsql_create_alter_foreign_server_failed, -901, "42", "000", "CREATE OR ALTER SERVER @1 failed")
FB_IMPL_MSG(SQLERR, 1056, dsql_recreate_foreign_server_failed, -901, "42", "000", "RECREATE SERVER @1 failed")
FB_IMPL_MSG(SQLERR, 1057, dsql_drop_foreign_server_failed, -901, "42", "000", "DROP SERVER @1 failed")
FB_IMPL_MSG(SQLERR, 1058, dsql_create_user_mapping_failed, -901, "42", "000", "CREATE USER MAPPING FOR USER @1 AND SERVER @2 failed")
FB_IMPL_MSG(SQLERR, 1059, dsql_alter_user_mapping_failed, -901, "42", "000", "ALTER USER MAPPING FOR USER @1 AND SERVER @2 failed")
FB_IMPL_MSG(SQLERR, 1060, dsql_create_alter_user_mapping_failed, -901, "42", "000", "CREATE OR ALTER USER MAPPING FOR USER @1 AND SERVER @2 failed")
FB_IMPL_MSG(SQLERR, 1061, dsql_recreate_user_mapping_failed, -901, "42", "000", "RECREATE USER MAPPING FOR USER @1 AND SERVER @2 failed")
FB_IMPL_MSG(SQLERR, 1062, dsql_drop_user_mapping_failed, -901, "42", "000", "DROP USER MAPPING FOR USER @1 AND SERVER @2 failed")
FB_IMPL_MSG(SQLERR, 1063, dsql_comment_on_user_mapping_failed, -901, "42", "000", "COMMENT ON USER MAPPING FOR USER @1 AND SERVER @2 failed")
FB_IMPL_MSG(SQLERR, 1064, dsql_foreign_table_not_found, -607, "42", "S02", "Foreign table @1 does not exist")
FB_IMPL_MSG(SQLERR, 1065, dsql_create_foreign_table_failed, -901, "42", "000", "CREATE FOREIGN TABLE @1 failed")
FB_IMPL_MSG(SQLERR, 1066, dsql_alter_foreign_table_failed, -901, "42", "000", "ALTER FOREIGN TABLE @1 failed")
FB_IMPL_MSG(SQLERR, 1067, dsql_drop_foreign_table_failed, -901, "42", "000", "DROP FOREIGN TABLE @1 failed")
FB_IMPL_MSG(SQLERR, 1068, dsql_recreate_foreign_table_failed, -901, "42", "000", "RECREATE FOREIGN TABLE @1 failed")
