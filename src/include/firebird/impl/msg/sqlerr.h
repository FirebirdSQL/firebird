...
FB_IMPL_MSG(SQLERR, 1063, dsql_foreign_table_not_found, -607, "42", "S02", "Foreign table @1 does not exist")
FB_IMPL_MSG(SQLERR, 1064, dsql_create_foreign_table_failed, -901, "42", "000", "CREATE FOREIGN TABLE @1 failed")
FB_IMPL_MSG(SQLERR, 1065, dsql_alter_foreign_table_failed, -901, "42", "000", "ALTER FOREIGN TABLE @1 failed")
FB_IMPL_MSG(SQLERR, 1066, dsql_drop_foreign_table_failed, -901, "42", "000", "DROP FOREIGN TABLE @1 failed")
FB_IMPL_MSG(SQLERR, 1067, dsql_recreate_foreign_table_failed, -901, "42", "000", "RECREATE FOREIGN TABLE @1 failed")
