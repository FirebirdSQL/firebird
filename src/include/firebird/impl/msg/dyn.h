...
FB_IMPL_MSG(DYN, 328, dyn_foreign_server_not_found, -901, "42", "000", "Foreign server @1 not found")
FB_IMPL_MSG(DYN, 329, dyn_user_mapping_not_found, -901, "42", "000", "User mapping for user @1 and server @2 not found")
FB_IMPL_MSG(DYN, 330, dyn_foreign_server_already_exists, -901, "42", "000", "Foreign server @1 already exists")
FB_IMPL_MSG(DYN, 331, dyn_foreign_server_not_exist, -901, "42", "000", "Foreign server @1 does not exist")
FB_IMPL_MSG_NO_SYMBOL(DYN, 332, "attempt to index a foreign table")
