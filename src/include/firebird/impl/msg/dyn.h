...
FB_IMPL_MSG_SYMBOL(DYN, 324, dyn_dup_blob_filter, "Blob filter @1 already exists")
FB_IMPL_MSG_SYMBOL(DYN, 335, dyn_const_not_found, "Constant @1 not found")
FB_IMPL_MSG_SYMBOL(DYN, 336, dyn_dup_const, "Constant @1 already exists")
FB_IMPL_MSG_SYMBOL(DYN, 337, dyn_non_constant_constant, "The constant \"@1\" must be initialized by a constant expression")
