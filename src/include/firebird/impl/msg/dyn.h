...
FB_IMPL_MSG(DYN, 324, dyn_ts_not_found, -901, "42", "000", "Tablespace @1 not found")
FB_IMPL_MSG(DYN, 325, dyn_cant_set_ts_table, -901, "42", "000", "Cannot set tablespace for @1")
FB_IMPL_MSG(DYN, 326, dyn_cant_set_ts_index, -901, "42", "000", "Cannot set tablespace for temporary index @1")
FB_IMPL_MSG(DYN, 327, dyn_dup_tablespace, -901, "42", "000", "Tablespace @1 already exists")
FB_IMPL_MSG(DYN, 328, dyn_cannot_mod_sys_ts, -901, "42", "000", "Cannot ALTER or DROP system tablespace @1")
