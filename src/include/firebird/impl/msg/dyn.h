...
FB_IMPL_MSG(DYN, 328, dyn_ts_not_found, -901, "42", "000", "Tablespace @1 not found")
FB_IMPL_MSG(DYN, 329, dyn_cant_set_ts_table, -901, "42", "000", "Cannot set tablespace for @1")
FB_IMPL_MSG(DYN, 330, dyn_cant_set_ts_index, -901, "42", "000", "Cannot set tablespace for temporary index @1")
FB_IMPL_MSG(DYN, 331, dyn_dup_tablespace, -901, "42", "000", "Tablespace @1 already exists")
FB_IMPL_MSG(DYN, 332, dyn_cannot_mod_sys_ts, -901, "42", "000", "Cannot ALTER or DROP system tablespace @1")
