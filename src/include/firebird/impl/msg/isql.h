...
FB_IMPL_MSG_SYMBOL(ISQL, 210, NO_TABLESPACE, "There is no tablespace @1 in this database")
FB_IMPL_MSG_SYMBOL(ISQL, 211, NO_TABLESPACES, "There are no tablespaces in this database")
FB_IMPL_MSG_SYMBOL(ISQL, 212, MSG_TABLESPACES, "Tablespaces:")
