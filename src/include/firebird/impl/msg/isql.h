...
FB_IMPL_MSG_SYMBOL(ISQL, 214, MSG_FOREIGN_SERVERS, "Servers:")
FB_IMPL_MSG_SYMBOL(ISQL, 215, MSG_FOREIGN_USER_MAPPINGS, "Foreign User Mappings:")
FB_IMPL_MSG_SYMBOL(ISQL, 216, NO_FOREIGN_SERVER, "There is no server @1 in this database")
FB_IMPL_MSG_SYMBOL(ISQL, 217, NO_FOREIGN_SERVERS, "There are no servers in this database")
FB_IMPL_MSG_SYMBOL(ISQL, 218, NO_FOREIGN_USER_MAPPING, "There is no user mappings for @1 in this database")
FB_IMPL_MSG_SYMBOL(ISQL, 219, NO_FOREIGN_USER_MAPPINGS, "There is no user mappings in this database")
