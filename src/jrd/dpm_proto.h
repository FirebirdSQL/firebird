...
void	DPM_delete_relation(Jrd::thread_db*, Jrd::RelationPermanent*, Jrd::RelationPages*);
...
void	DPM_mark_relation(Jrd::thread_db*, Jrd::jrd_rel*);
bool	DPM_next(Jrd::thread_db*, Jrd::record_param*, USHORT, Jrd::FindNextRecordScope);
void	DPM_pages(Jrd::thread_db*, MetaId, int, ULONG, const Jrd::PageNumber&);
...
void	DPM_scan_pages(Jrd::thread_db*, SCHAR pagType = 0);
void	DPM_scan_pages(Jrd::thread_db*, Jrd::RelationPermanent*, Jrd::RelationPages*);
...
void DPM_copy_data(Jrd::thread_db* tdbb, Jrd::RelationPermanent*,
				   Jrd::RelationPages* orgPages, Jrd::RelationPages* newPages);
