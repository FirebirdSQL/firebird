...
RELATION(nam_user_privileges, rel_priv, ODS_8_0, rel_persistent)
	...
	FIELD(f_prv_rel_schema, nam_rel_sch_name, fld_sch_name, 1, ODS_14_0)	// FIXME: rename to RDB$SCHEMA_NAME
...
RELATION(nam_mon_attachments, rel_mon_attachments, ODS_11_1, rel_virtual)
	...
	FIELD(f_mon_att_search_path, nam_mon_search_path, fld_search_path, 0, ODS_14_0)
END_RELATION
