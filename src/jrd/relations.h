...
// Relation 58 (MON$LOCAL_TEMPORARY_TABLE_FIELDS)
RELATION(nam_mon_local_temp_table_fields, rel_mon_local_temp_table_fields, ODS_14_0, rel_virtual)
	FIELD(f_mon_lttf_att_id, nam_mon_att_id, fld_att_id, 0, ODS_14_0)
	FIELD(f_mon_lttf_name, nam_mon_tab_name, fld_r_name, 0, ODS_14_0)
	FIELD(f_mon_lttf_schema, nam_mon_sch_name, fld_sch_name, 0, ODS_14_0)
	FIELD(f_mon_lttf_field_name, nam_mon_f_name, fld_f_name, 0, ODS_14_0)
	FIELD(f_mon_lttf_position, nam_mon_f_position, fld_f_position, 0, ODS_14_0)
	FIELD(f_mon_lttf_type, nam_mon_f_type, fld_f_type, 0, ODS_14_0)
	FIELD(f_mon_lttf_precision, nam_mon_f_precision, fld_f_precision, 0, ODS_14_0)
	FIELD(f_mon_lttf_scale, nam_mon_f_scale, fld_f_scale, 0, ODS_14_0)
	FIELD(f_mon_lttf_char_length, nam_mon_char_length, fld_f_length, 0, ODS_14_0)
	FIELD(f_mon_lttf_length, nam_mon_f_length, fld_f_length, 0, ODS_14_0)
	FIELD(f_mon_lttf_sub_type, nam_mon_f_sub_type, fld_sub_type, 0, ODS_14_0)
	FIELD(f_mon_lttf_not_null, nam_mon_null_flag, fld_null_flag, 0, ODS_14_0)
	FIELD(f_mon_lttf_charset_id, nam_mon_charset_id, fld_charset_id, 0, ODS_14_0)
	FIELD(f_mon_lttf_collate_id, nam_mon_collate_id, fld_collate_id, 0, ODS_14_0)
END_RELATION
